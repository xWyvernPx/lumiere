  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        className="pointer-events-none block h-4 w-4 bg-foreground data-[state=checked]:bg-background data-[state=checked]:translate-x-5 translate-x-1 transition-transform duration-150 rounded-none"
      />
    </SwitchPrimitive.Root>
  )
}
